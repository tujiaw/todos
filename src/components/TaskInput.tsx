...
export const TaskInput: React.FC<TaskInputProps> = ({
  ...
  return (
    <div id="task-input-card" className="task-composer h-full p-4 sm:p-5 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/70 dark:border-slate-800 transition-all">
      <form onSubmit={handleSubmit}>
        <div className="mb-3">
          <p className="text-[10px] font-bold tracking-[0.16em] text-indigo-600 dark:text-indigo-400 uppercase">Quick capture</p>
          <h3 className="mt-1 text-sm font-bold text-slate-950 dark:text-white">What needs your attention?</h3>
        </div>
        ...
        <div className="flex items-center gap-2">
          <div className="flex-1 relative">
            <input
              ...
              className="w-full text-base font-semibold text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 bg-slate-50/80 dark:bg-slate-800/70 rounded-2xl px-4 py-3.5 focus:outline-none focus:ring-2 focus:ring-indigo-500/20"
              maxLength={100}
              required
            />
          </div>
          ...
          <button
            ...
            className="px-4 py-2 bg-gradient-to-br from-blue-600 to-indigo-700 hover:from-blue-500 hover:to-indigo-600 disabled:opacity-50 text-white text-xs font-bold rounded-xl shadow-lg shadow-indigo-500/20 transition-all flex items-center gap-1.5 shrink-0 min-h-[42px] active:scale-95"
          >
        ...
        <div className="composer-options flex flex-wrap items-center gap-2 mt-3">
          {/* Category Selector */}
